...
const MeetingModal = ({ isOpen, onClose, image,
  title, className, buttonText,
  buttonIcon, handleClick, children } : MeetingModalProps) => {
  ...
  return (
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="flex flex-col w-full items-center max-w-[520px]
